...
function Destination() {
  const destinations = [
    ...
    {
      name: "Jaipur",
      image: "https://assets.minorhotels.com/image/upload/q_auto,f_auto/media/minor/anantara/images/anantara-jewel-bagh-jaipur-hotel/mhg/01_hotel-teaser/anantara_jewel-bagh_jaipur_hotel_teaser_01_880x620.jpg",
      description: "The Pink City known for forts, palaces, and rich culture."
    },
    {
      name: "Kerala",
      image: "https://lp-cms-production.imgix.net/2024-09/shutterstock2483760103.jpg?auto=format,compress&q=72&fit=crop",
